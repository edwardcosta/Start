...
/**
 * Created by eduar on 09/06/2017.
 */

public class MyProjectsView extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mProjectsDatabaseReference = Database.getUsersReference().child(userProfile.getId()).child("myProjects");
